...
void leer_humedad(void) {
    ...
    /* Tiene que haber un while que compruebe si el CAD está en uso o no
...
void init_CAD(void) {
  // Da al CAD los valores comunes a todas las patas
  ...
  ADCON0bits.ADON    = 1; /* ¿Encendemos y dejamos encendido, o vamos encendiendo y apagando
                             según lo usen y dejen de usarlo las patitas? */
